...
class OmraModel {
  ...
  OmraModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    type = json['type'];
    status = json['status'];
    ...
    if (json['omraDepartures'] != null) {
      departures = <DepartureModel>[];
      json['omraDepartures'].forEach((v) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (departures != null) {
      data['omraDepartures'] = departures!.map((v) => v.toJson()).toList();
    }
