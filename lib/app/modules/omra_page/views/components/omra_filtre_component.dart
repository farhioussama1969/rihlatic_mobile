...
import 'package:rihlatic/app/modules/omra_page/controllers/omra_page_controller.dart';
import 'package:rihlatic/app/modules/omra_page/views/components/add_quantity_component.dart';

class OmraFiltreComponent extends StatelessWidget {
  final int roomCount = 3;
  final int guestCount = 4;

  const OmraFiltreComponent({super.key});
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<OmraPageController>();
