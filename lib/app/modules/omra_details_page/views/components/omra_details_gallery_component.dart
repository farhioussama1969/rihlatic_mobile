...
class OmraDetailsGalleryComponent extends StatefulWidget {
  final List<String> images;

  const OmraDetailsGalleryComponent({super.key, required this.images});

  @override
  State<OmraDetailsGalleryComponent> createState() =>
      _PackageDetailsGalleryComponentState();
}

class _PackageDetailsGalleryComponentState
    extends State<OmraDetailsGalleryComponent> {
